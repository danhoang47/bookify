...
public class NotificationDAO {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        System.out.println(notifDao.getNotification("af2a30da-6bb4-4b6d-8a4e-6324cafad135"));
    }
    ...
    public NotificationDTO getNotification(String sourceId) throws SQLException {
        ...
        CallableStatement cs = null;
        ResultSet rs = null;
        String sql = "proc_getAllNotification @sourceId = ?";
        NotificationDTO notif = null;

        try {
            conn = DBContext.getConnection();
            cs = conn.prepareCall(sql);
            cs.setString(1, sourceId);
            rs = cs.executeQuery();
            ...
            while(rs.next()) {
                ...
                notif = new NotificationDTO(id, userId, hotelId, 
                        sourceId, notifyTYpe, notifyDate, hotelName, actorName, isRead, actorAvatar, actorId);
            }
