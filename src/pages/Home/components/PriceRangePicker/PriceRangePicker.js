...
function PriceRangePicker({ prices }) {
    ...
    return (
        <div id={priceRangePickerStyles["price-range-picker"]}>
            <h4 className={priceRangePickerStyles["heading"]}>
                Khoảng giá phòng
            </h4>
            <p className={priceRangePickerStyles['sub-heading']}>Giá trung bình mỗi đêm là <span className={priceRangePickerStyles['average-price']}>$200</span></p>
            <div className={priceRangePickerStyles["price-inputs"]}>
                ...
                >
                    ...
                    <div className={priceRangePickerStyles["currency"]}>
                      USD
                    </div>
                </div>
