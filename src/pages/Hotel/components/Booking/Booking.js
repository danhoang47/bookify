            ...
            <div className={bookingStyles["booking-input"]}>
                ...
                >
                    ...
                    {isSelectBoxOpen["datePickerBox"] && (
                        <div
                            className={[
                                bookingStyles["date-range-input-box"],
                            ].join(" ")}
                            onClick={(e) => {
                                e.stopPropagation();
                            }}
                        >
                            <div
                                className={bookingStyles["date-range-heading"]}
                            >
                                <div className={bookingStyles["heading"]}>
                                    Chọn ngày
                                </div>
                                <div
                                    className={
                                        bookingStyles["date-range-input-modal"]
                                    }
                                >
                                    <div
                                        className={
                                            bookingStyles["modal-start-day"]
                                        }
                                    >
                                        <div className={bookingStyles["label"]}>
                                            <p
                                                className={
                                                    bookingStyles["modal-title"]
                                                }
                                            >
                                                Nhận phòng
                                            </p>
                            ...
                            <div className={bookingStyles["button-row"]}>
                                <button
                                    className={
                                        bookingStyles["close-date-picker"]
                                    }
                                    onClick={() => handleClick("datePickerBox")}
                                >
                                    Đóng
